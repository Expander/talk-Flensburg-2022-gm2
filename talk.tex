...
\begin{frame}{\insertsection: Fermilab (FNAL)}
  \begin{columns}
    ...
    \begin{align*}
      \mu^+ \to e^+ + \nu_e + \bar{\nu}_\mu
    \end{align*}
    The energy of the decay products depends on the muon's spin direction.
    \column{0.6\textwidth}
    \centering
...
\begin{frame}{\insertsubsection}
  \begin{center}
    \includegraphics[width=0.6\textwidth]{scans/MSSM/scan.pdf}
  \end{center}
\end{frame}
...
\note{
  ...
  \item Here is an example plot that shows the region (green) where
    ...
    of the two new particle masses of the model.
  \end{itemize}
}
