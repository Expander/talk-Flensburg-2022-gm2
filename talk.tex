...
\begin{frame}{\insertsection}
  Mehrere Abbildungen der folgenden Form, mit verschiedener
  Feldstärke, zzgl.\ entsprechendem magnetic moment:
  \begin{center}
    \includegraphics[width=0.5\textwidth]{img/bar_magnet}
