...
\begin{frame}{Electron $g$-factor: Quantum Corrections}
  \begin{center}
    \begin{tikzpicture}
      \draw[fill,green] (0,0) coordinate (e) circle (0.1) node[right] {$e$};
      \draw[very thick,green,->] ($(e)+(0,-0.5)$) -- ++(0,1);
      \begin{scope}[shift={(4,2)},rotate={atan(2/4)}]
        \def\lmag{1.8}  % length of magnet
        \def\wmag{0.5}  % thickness of magnet
...
\note{
  ...
  \item The currently best theory that describes this interaction is
    the Standard Model of Particle Physics.
  \item In the Standard Model this interaction is described by the
    exchange of photons $\gamma$.
...
\begin{frame}{\insertsection: Fermilab (FNAL)}
  \begin{center}
    \movie[width=0.9\textwidth,autostart,loop]{\includegraphics[width=0.9\textwidth]{videos/Muon-g-2-moving.png}}{videos/Muon-g-2-moving.mp4}
